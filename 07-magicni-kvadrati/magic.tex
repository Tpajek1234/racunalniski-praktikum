...
\usepackage{lmodern}
\usepackage{amsmath}
\usepackage{amsthm} % Paket za izreke, definicije, dokaze
\usepackage{url}
\usepackage{graphicx}
\usepackage{booktabs}
\usepackage{xcolor}
% Definicija okolij
\usepackage{array} % Za napredno oblikovanje tabel
...
\begin{table}[htp]
 ...
 \begin{tabular}{lcccccc}
     \hline
     & \multicolumn{5}{c}{Točna vrednost} & približek  \\ % Združevanje stolpcev
     \midrule
